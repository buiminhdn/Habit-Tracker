...
function HomePreview() {
  ...
  return (
    <section className="hidden lg:block mt-40 max-w-7xl mx-auto relative group transition-all duration-1000 transform px-8">
      <div className="bg-white rounded-4xl border border-zinc-100 shadow-2xl overflow-hidden flex border-b-0">
        {/* Sidebar Mockup */}
        <div className="w-72 border-r border-zinc-50 p-10 hidden md:flex flex-col gap-6 bg-zinc-50/20">
        ...
        <div className="flex-1 p-14 space-y-14 bg-white overflow-hidden relative">
          <div className="flex justify-between items-end">
            <div className="space-y-4">
              <div className="inline-flex items-center gap-2 text-xs font-black uppercase tracking-widest text-zinc-400 font-heading">
                <Clock size={14} />
